---
description: Router — names the two onboarding commands. Prepares nothing itself.
---

This command does not prepare anything, and does not guess which layer you mean.

Print exactly this and stop:

> **Which layer are you onboarding?**
