...
consumes_raw: **Implements:** the upsell promise in [35-offline-mode.md](35-offline-mode.md) ("the format is chosen so a client can later **upsell to hybrid** by pushing all local data to the backend in one operation"); platform foundation P16.
