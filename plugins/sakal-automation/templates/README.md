...
| `rules-template.md` (**built**) | `docs/RULES.md` | binding safeguards (@imported via CLAUDE.md): verify-first, escalation, the verify.sh gate, denylist, issue process rules, changelog duty |
